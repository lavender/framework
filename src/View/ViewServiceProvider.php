...
class ViewServiceProvider extends ServiceProvider
{
    ...
    {
        return ['theme', 'current.theme', 'message.service', 'asset.publisher', 'lavender.theme.creator'];
    }
    ...
    {
        $this->package('lavender/view', 'view', realpath(__DIR__));
    ...
    private function inject(Factory $factory, array $sections)
    {
        foreach($sections as $sectionName => $children){
            ...
            foreach($children as $childName => $childConfig){
                ...
                if($childConfig['layout'] instanceof \Closure){
                    // todo remove (path hints)
