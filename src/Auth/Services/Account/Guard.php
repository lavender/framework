<?php
namespace Lavender\Auth\Services\Account;
...
class Guard extends CoreGuard
{
     ...
     * @return UserInterface
     */
    public function refresh(UserInterface $account)
    {
     ...
     * @return bool
     */
    private function confirm(UserInterface $account)
    {
     ...
     *
     * @return  UserInterface User object that may or may not be saved successfully. Check the id to make sure.
     */
     ...
     *
     * @param  UserInterface $instance
     *
     * @return  boolean Success
     */
    public function save(UserInterface $instance)
    {
    ...
    public function checkPassword(UserInterface $account, array $input)
    {
